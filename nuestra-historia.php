...
<div class="about-bottom wthree-3">
		<div class="container">
		<h2 class="tittle">Nuestra Historia</h2>
			<div class="agileinfo_about_bottom_grids">
				<div class="col-md-6 agileinfo_about_bottom_grid">
					<p>Proyecto 87 es una empresa orientada a la gerencia, promoción y venta de proyectos inmobiliarios que busca satisfacer a sus clientes, con diseños estéticos y funcionales, generosas áreas comunes y recreativas, zonas verdes, precios muy competitivos y su excelente servicio. Proyecto 87 inicia labores en 2014 en la ciudad de La Paz, bajo el nombre Open Door, con el primer proyecto urbanístico llamado Ciudadela Estronguista que constaba de un total de 53 lotes de terrenos rústicos en el municipio de Mecapaca.

El año 2015 toma el proyecto “Urbanización Valle de Sol” 64 terrenos rústicos ubicados en Irpavi II de la ciudad de La Paz-Bolivia. 
En el año 2017 por circunstancias ajenas a su voluntad cambia su nombre a PROYECTO 87 con la finalidad de “Ofrecer la mejor ubicación, el mejor proyecto y la mejor calidad al mejor precio del mercado”. Todo ello con un claro compromiso con el cliente. Actualmente la empresa incursiona en la promoción de un nuevo proyecto “Serranías del Golf” una urbanización con denominación exclusiva ubicada en Mallasilla – Zona Sur de la ciudad de La Paz, Bolivia. 
Con un profundo conocimiento de las distintas zonas de la ciudad, sus necesidades y ventajas, Proyecto 87 está promocionando proyectos llamados a convertirse en referentes para todo aquel que busque un terreno, departamento o vivienda, que se convierta en una inversión definitiva y segura. 
</p>
				</div>
				<div class="col-md-6 agileinfo_about_bottom_grid">
