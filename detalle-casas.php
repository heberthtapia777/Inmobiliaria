				...
				<div class="container">
					<div class="services-grids">
						<div class="col-md-12 services-grid">
                        	<h3 align="center"><b><?php echo $casa->DETALLE?></b></h3><br>
							<div class="col-md-8 serv-img mask">
								<?php $imagenes = explode("@",$casa->IMAGEN);?>
                    ...
                    <div class="desc">
                        <h3>Descripcion</h3>
						<p><?php	$datos = explode("|",$casa->CAPACIDAD); 
