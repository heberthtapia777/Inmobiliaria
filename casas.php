	...
	<div class="friend-agent agileits-1">
				<div class="container">
					<div class="friend-grids">
                    	<header><br>
                                <h1 id="tittle">Nuestras Casas</h1><br>
                        </header>
                        <?php foreach($casas as $Index => $Record){ 
                        ...
                        ?>
							<div class="col-md-4 friend-grid">
								...
								<h4><?php echo "Propiedad ".($Index+1)?></h4>
								<p id="texto"><?php echo $Record["DETALLE"]?></p>
								<a href="detalle-casas.php?id=<?php echo $Record["ID_CASA"]?>"><button class="btn btn-info btn-md" type="button" data-toggle="modal" data-target="#contacto3">Mas detalles:</button></a>
							</div>
							<?php if(($Index+1) % 3 == 0){?>
