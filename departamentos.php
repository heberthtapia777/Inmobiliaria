	...
	<div class="friend-agent agileits-1">
				<div class="container">
					<div class="friend-grids">
                    	<header><br>
                                <h1 id="tittle">Nuestros Departamentos</h1><br>
                        </header>
                        <?php foreach($departamentos as $Index => $Record){ 
                        	$imagen = explode("@",$Record["IMAGEN"]);
        					$_ruta = "admin/".$imagen[0];
                        	
                        ?>
							<div class="col-md-6 friend-grid">
								<img src="<?php echo $_ruta?>" alt="" class="img-responsive img-thumbnail" >
								<h4><?php echo "Departamento ".($Index+1)?></h4>
								<p id="texto"><?php echo $Record["DETALLE"]?></p>
								<a href="detalle-departamentos.php?id=<?php echo $Record["ID_DEPARTAMENTO"]?>"><button class="btn btn-info btn-md" type="button" data-toggle="modal" data-target="#contacto3">Mas detalles:</button></a>
							</div>
							<?php if(($Index+1) % 3 == 0){?>
