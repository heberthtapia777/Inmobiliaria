				...
				<div class="container">
					<div class="services-grids">
						<div class="col-md-12 services-grid">
                        	<h3 align="center"><b>Urbanizacion: <?php echo $urbanizacion->NOMBRE;?>, Manzano: <?php echo $manzano->NOMBRE;?></b></h3><br>
							<div class="col-md-12 serv-img mask">
								<?php if(isset($manzano->IMAGEN)){
									$imagen = explode("@",$manzano->IMAGEN);
                    ...
                    <div class="desc">
						...
						Departamento: <?php echo $urbanizacion->DEPARTAMENTO; ?><br>
						Manzano: <?php echo $manzano->NOMBRE; ?><br>
						Numero de lotes: <?php echo $manzano->NUMERO_LOTES; ?>
						</p>
            		</div>
<header>
<br>
<!-- friend-agent -->
	<div class="friend-agent agileits-1">
				<div class="container">
                <span class="parpadea text"><strong>IMPORTANTE</strong></span>
					<div class="friend-grids">
						<div class="col-md-4 friend-grid">
							<h4>Lotes Disponibles</h4>
							<button type="button" class="btn btn-success btn-lg"><span class="glyphicon glyphicon-home"></span>Mas detalles...</button>
						</div>
						<div class="col-md-4 friend-grid">
							<h4>Lotes Reservados</h4>
							<button type="button" class="btn btn-primary btn-lg disabled"><span class="glyphicon glyphicon-home"></span>Mas detalles...</button>
						</div>
						<div class="col-md-4 friend-grid">
							<h4>Lotes Vendidos</h4>
							<button type="button" class="btn btn-danger btn-lg disabled"><span class="glyphicon glyphicon-home"></span>Mas detalles...</button>
						</div>
						<div class="clearfix"></div>
					</div>
				</div><br><br>
                <div>
                <p><b>Si desea mas informacion de nuestros terrenos haga click en mas detalles, quiza los botones de los terrenos <span class="parpadea" style="color:red;">Reservados</span> y <span class="parpadea" style="color:red;">Vendidos</span> esten desactivados, para mas informacion sobre los mismos contactese con nosotros mediante nuestro formulario de contacto <a href="contactos">&nbsp;Click aqui</a></b></p>
                </div>
	</div>
<!-- friend-agent -->
<br><br>
<h1>Lotes del Manzano <?php echo $manzano->NOMBRE?></h1>
</header>                    
		<div class="container galeria">
        	<articles class="row">
        		<?php foreach($lotes as $Index => $Record){
        			$imagen = explode("@",$Record["IMAGEN"]);
        			$_ruta = "admin/".$imagen[0];
        			?>
            	<article class="col-md-3">
            		<div align="center"><?php echo $Record["NUMERO_LOTE"].": ".$Record["DETALLE"]?></div>
                    ...
                    <p> <?php 
                    	...
                    	?>                    	
                    	<a href="detalle-lotes.php?id=<?php echo $Record["ID_LOTE"]?>" class="<?php echo $clase; ?>">&nbsp;Mas detalles</a>
