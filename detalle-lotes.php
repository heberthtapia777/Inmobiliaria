...
<script>
	...
	initMapView(<?php echo $georeferencia[0]?>,<?php echo $georeferencia[1]?>, <?php echo '"'.$urbanizacion->NOMBRE.' - '.$manzano->NOMBRE.'"';?>);
				...
				<div class="container">
					<div class="services-grids">
						<div class="col-md-12 services-grid">
                        	<h3 align="center"><b>Urbanizacion: <?php echo $urbanizacion->NOMBRE?> - Manzano: <?php echo $manzano->NOMBRE ?> - Lote: <?php echo $lote->NUMERO_LOTE?></b></h3><br>
							<div class="col-md-8">
										<!--borrar-->
                                        <div id="myCarousel" class="carousel slide" data-ride="carousel">
                                            <!-- Indicators -->
                                            <ol class="carousel-indicators">
                                            	<?php $imagenes = explode("@",$lote->IMAGEN); 
                                            	foreach($imagenes as $Index => $imagen){
                                            		$clase = '';
                                            		if($Index==0)	$clase = 'class="active"';
                                            	?>
                                                <li data-target="#myCarousel" data-slide-to="<?php echo $Index?>" <?php echo $clase?>></li>
                                                <?php }?>
                                            </ol>
                                            ...
                                            <div class="carousel-inner">
                                            	<?php foreach($imagenes as $Index => $imagen){ 
                                            		$clase = "item";
                                            		if($Index==0)	$clase = "item active";
                                            	?>
                                                <div class="item <?php echo $clase;?>">
                                                    <img src="<?php echo "admin/".$imagen?>" alt="">
                                                </div>
                                                <?php } ?>
                                            </div>
                                ...
                                <div class="main">
                                    <div class="main-w3l">
                                        <div class="w3layouts-main">
                                            <h2><span>Contacto con nuestros Agentes</span></h2>
...
.google-maps iframe {
    ...
    height: 100% !important;
                    ...
                    <div class="demo">
                        ...
                        <div>
                            <ol style="color:#fff;">
                            	<li>Lote: <?php echo $lote->DETALLE;?></li>
                                <li>Urbanizacion: <?php echo $urbanizacion->NOMBRE?></li>
                                <li>Manzano: <?php echo $manzano->NOMBRE?></li>                                
                            </ol> 
                        </div>
                        <div>
                        <div>
                        	<div id="mapaV" ></div>
                        	<!-- <iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d1912.868174438894!2d-68.1153504!3d-16.4888825!3m2!1i1024!2i768!4f13.1!5e0!3m2!1ses!2sbo!4v1544543029896" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
                        	-->
                        </div>
                        </div>
                        <div>
                        	<?php $imagen = explode("@",$lote->IMAGEN);?>
                        	<img src="<?php echo "admin/".$imagen[0]?>" class="img-responsive img-rounded">
                        </div>
                        </div>
                        </div>
                        <br />
