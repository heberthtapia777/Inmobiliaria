...
<div class="about-bottom wthree-3">
		<div class="container">
		<h2 class="tittle">Asesoria Financiera</h2>
...
Asesoramos y lo orientamos en:
					...
					<p><b>Asesoramiento en temas de financiamiento,</b><br> identificaremos cual es la mejor alternativa para usted y como desenvolverse en las diferentes entidades bancarias.</p>
				</div>
				<div class="col-md-6 agileinfo_about_bottom_grid">
