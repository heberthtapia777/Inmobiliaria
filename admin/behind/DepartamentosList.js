...
function AbrirImagenes(idDepartamento){
	//console.log("ssss");
	$("#DepartamentosView").load('DepartamentosView.php?ID='+idDepartamento);	
}
function eliminar(id){
    if(confirm("Seguro de eliminar el registro?")){
        location = 'DepartamentosDelete.php?ID='+id;
    }
}
function editar(id){	
	$("#DepartamentosEdit").load('DepartamentosEdit.php?ID='+id);	
}
