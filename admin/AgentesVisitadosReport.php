<?php 
    ...
    if (isset($_POST["FECHA_INICIO"]) && isset($_POST["FECHA_FIN"])){
    	...
    	$Data = Reporte::getListadoAgentesMasVisitados($fecha_inicio, $fecha_fin);
            ...
            <div class="col-md-12">
                <div class="card">
                        <div class="card-action">
                             Reporte por agentes con mas visitas agendadas
                        </div>
                        
                        <div class="card-content">
                        	<form class="" autocomplete="off" id="form" name="formNew" method = "POST" action="AgentesVisitadosReport.php">
