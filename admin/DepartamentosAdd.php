<?php 
	...
	foreach($Data as $Index => $Record){             
		if($Record["ID_DEPARTAMENTO"]>$max)
			$max = $Record["ID_DEPARTAMENTO"]; 
	}
...
?>		
		...
		<div class="card">
            <div class="card-content">
                <form class="" autocomplete="off" id="formNew" name="formNew" method = "POST" action="DepartamentosAddSave.php">
                    <div class="row">
                    ...
                    <div class="row">
						...
						<div class="input--group col s11" align="center">
							<div align="left">
		                    	...
		                    	<textarea id="OTROS" name="OTROS" class="form-control" rows="1" ></textarea>
		                    </div>	                        
		                </div>
